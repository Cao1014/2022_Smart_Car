...
/* USER CODE BEGIN 0 */
short aADCxConvertedData[ADC_CONVERTED_DATA_BUFFER_SIZE];
...
//	LL_DMA_SetMemoryAddress(DMA1,LL_DMA_CHANNEL_1,(uint32_t)aADCxConvertedData);
  ...
  */
  ...
  LL_ADC_SetSamplingTimeCommonChannels(ADC1, LL_ADC_SAMPLINGTIME_COMMON_2, LL_ADC_SAMPLINGTIME_7CYCLES_5);
