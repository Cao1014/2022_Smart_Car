...
void MX_TIM6_Init(void)
{
  ...
  /* USER CODE BEGIN TIM6_Init 2 */
	LL_TIM_EnableIT_UPDATE(TIM6);//开启中断
...
void MX_TIM14_Init(void)
{
  ...
  /* USER CODE BEGIN TIM14_Init 2 */
	...
	if (LL_TIM_CC_IsEnabledChannel(TIM14, LL_TIM_CHANNEL_CH1) != 01U)
  {
...
void MX_TIM15_Init(void)
{
  ...
  /* USER CODE BEGIN TIM15_Init 2 */
	...
	LL_TIM_EnableIT_UPDATE(TIM15);//开启中断
...
void MX_TIM17_Init(void)
{
  ...
  */
  ...
  LL_TIM_IC_SetFilter(TIM17, LL_TIM_CHANNEL_CH1, LL_TIM_IC_FILTER_FDIV32_N8);
